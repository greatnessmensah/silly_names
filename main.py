...
def main():
    """Silly name generator inspired by the TV dramedy Psych
    """
    ...
    first = (' Baby Oil', 'Bad News', 'Big Burps', "Bill 'Beenie-Weenie'", "Bob 'Stinkbug'",
             ...
             '" Lunch Money"', 'Mergatroid', '" Mr Peabody"', 'Oil-Can',
             'Oinks', 'Old Scratch', 'Ovaltine', 'Pennywhistle', 'Pitchfork Ben', 'Potato Bug',
    ...
    while True:
        ...
        print(f"Your name is: {first_name} {last_name}", file=sys.stderr)
        print("\n")
